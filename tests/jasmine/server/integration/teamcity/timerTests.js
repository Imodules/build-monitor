...
describe('timerController', function () {
	describe('onPollInterval()', function () {
		...
		beforeAll(function () {
			...
			console.log('timerController.onPollInterval-ServerId: ' + serverId);
			...
			bd_112767 = JSON.parse(Assets.getText('testData/builds/tcRunningBuildDetail_001.json'));
			bd_112766 = JSON.parse(Assets.getText('testData/builds/tcRunningBuildDetail_002.json'));
		});
